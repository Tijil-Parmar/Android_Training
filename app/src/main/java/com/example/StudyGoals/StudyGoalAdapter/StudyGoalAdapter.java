...
//import static com.example.StudyGoals.StudyGoalAdapter.StudyGoalAdapter.StudyGoalOrder.DAILY_REMINDER_SWITCH;
//import static com.example.StudyGoals.StudyGoalAdapter.StudyGoalAdapter.StudyGoalOrder.EXAM_DATE;
//import static com.example.StudyGoals.StudyGoalAdapter.StudyGoalAdapter.StudyGoalOrder.NUMBER_OF_QUESTIONS;
//import static com.example.StudyGoals.StudyGoalAdapter.StudyGoalAdapter.StudyGoalOrder.TIME_GOAL;
//
...
//        switch (order){
//            case EXAM_DATE:
//                view1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.examdate_studygoal,parent,false);
//
//            case NUMBER_OF_QUESTIONS:
//                view1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.numberofquestions_studygoal,parent,false);
//
//            case TIME_GOAL:
//                view1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.time_goal_studygoal,parent,false);
//
//            case DAILY_REMINDER_SWITCH:
//                view1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.dailyreminder_switch_studygoal,parent,false);
//        }
